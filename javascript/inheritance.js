...
$(document).ready(function () {
    ...
    BadProgrammer.prototype = {
        ...
        THOUGHTS: "runtime error 138? wanna debug XD!",
        say: function () { 
          this.THOUGHTS = this.Man.THOUGHTS; 
          this.Man.say.apply(this); 
        }
    };
...
$(document).ready(function () {
    ...
    function Mammy() { 
      this.mammy_message = "You Dont love me!" 
    };
    Mammy.prototype = {
        __class_name: "Mammy",

        say_something_wise: function () { 
          console.log(this.mammy_message) 
        }
    };

    function Daddy() { 
      this.daddy_message = "I just don't want to be a dad!" 
    };
    Daddy.prototype = {
        __class_name: "Daddy",

        say_something_wise: function () { 
          console.log(this.daddy_message) 
        }
    };
